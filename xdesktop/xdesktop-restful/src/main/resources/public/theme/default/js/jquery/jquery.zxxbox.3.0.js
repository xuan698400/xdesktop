...
(function ($) {
    ...
    var LG = 'linear-gradient(top, #fafafa, #eee)', CSS = '<style type="text/css">' +
        ...
        '.wrap_bar{height:40px; line-height:40px;background: #507FAC; cursor:pointer;}' +
        ...
        '.submit_btn, .cancel_btn{width:96px; height:35px; line-height:35px; color:#fff; background:#507fac; font-size:14px; font-weight:bold;border-radius: 3px; cursor:pointer;}' +
        '.submit_btn{}' +
        '.submit_btn:hover{text-decoration:none;color:#fff;}' +
        '.cancel_btn{background:#ddd;color:#fff;font-weight:normal;}' +
        '</style>';
    $("head").append(CSS);
    ...
    $.extend($.zxxbox, {
        ...
        //remind2提醒方法,2S后会自动消息
        remind2: function (message, callback, options) {
